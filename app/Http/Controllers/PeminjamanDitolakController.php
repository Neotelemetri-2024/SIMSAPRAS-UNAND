...
class PeminjamanDitolakController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.peminjamanditolak', compact('peminjamanDitolak', 'search', 'sort', 'title', 'saranas', 'saranaFilter', 'dateFrom', 'dateTo'));
    }
