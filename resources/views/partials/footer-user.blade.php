<footer class="bg-gray-900 @unless (request()->routeIs('home')) mt-32 @endunless">
       ...
       <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div>
             ...
             <ul class="text-gray-400">
                ...
                <li class="mb-4"><a href="{{ route('home') }}#faq" class="hover:underline">FAQ</a></li>
             </ul>
          </div>
       </div>
       <hr class="my-6 border-gray-700 lg:my-8">
       <div class="text-center">
         <span class="block text-sm text-center text-gray-400">© {{ date('Y') }} SIMSAPRAS by <a href="https://www.instagram.com/neotelemetri" target="_blank" class="hover:text-white hover:underline">Neo Telemetri</a></span>
