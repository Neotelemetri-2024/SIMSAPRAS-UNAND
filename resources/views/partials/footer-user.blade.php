<footer class="bg-gray-900 @unless (request()->routeIs('home')) mt-32 @endunless">
    <div class="max-w-screen-2xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
       ...
       <div class="text-center">
         <span class="block text-sm text-center text-gray-400">© 2024 SIMSAPRAS by <a href="https://www.instagram.com/neotelemetri" target="_blank" class="hover:text-white hover:underline">Neo Telemetri</a></span>
