        ...
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                ...
                <div class="relative">
                    ...
                    <!-- Dropdown menu -->
                    <div class="absolute right-0 z-50 hidden w-48 mt-2 origin-top-right bg-white rounded-lg shadow-lg" id="user-dropdown">
                        ...
                        <ul class="py-2" role="none">
                            <li>
                                <a href="{{ route('password.change') }}" class="flex items-center px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 transition-colors">
