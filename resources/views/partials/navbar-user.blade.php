            ...
            <li class="relative w-full md:w-auto">
               ...
               <div id="dropdownNavbar2" class="z-10 hidden w-full md:w-44 font-normal bg-white divide-y divide-gray-100 md:rounded-lg shadow md:absolute md:left-0">
                  <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                     <li>
                        <a href="#" class="block px-4 py-2 hover:bg-gray-100 {{ request()->routeIs('panduan*') ? 'text-green-600' : '' }}">
                           Panduan Pengguna
                        </a>
                     </li>
                     <li>
                        <a href="{{route('pengumuman.user')}}" class="block px-4 py-2 hover:bg-gray-100 {{ request()->routeIs('pengumuman') ? 'text-green-600' : '' }}">
                           Pengumuman
                        </a>
                     </li>
                     <li>
                        <a href="#" class="block px-4 py-2 hover:bg-gray-100 {{ request()->routeIs('download*') ? 'text-green-600' : '' }}">
                           Download
                        </a>
                     </li>
                  </ul>
                     ...
                     <ul class="py-2" aria-labelledby="user-menu-button">
                        <li>
                           <a href="{{ route('profile.index') }}" 
                              class="block px-4 py-2 text-sm {{ request()->routeIs('profile*') ? 'text-green-600' : 'text-gray-700' }} hover:bg-gray-100">
                              Profile
                           </a>
                        </li>
