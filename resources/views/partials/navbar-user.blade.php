                        ...
                        <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                            <li>
                                <a href="{{ route('panduan.index') }}"
                                    class="block px-4 py-2 hover:bg-gray-100 {{ request()->routeIs('panduan*') ? 'text-green-600' : '' }}">
                                    Panduan Pengguna
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('pengumuman.user') }}"
                                    class="block px-4 py-2 hover:bg-gray-100 {{ request()->routeIs('pengumuman') ? 'text-green-600' : '' }}">
                                    Pengumuman
                                </a>
                            </li>
                        </ul>
