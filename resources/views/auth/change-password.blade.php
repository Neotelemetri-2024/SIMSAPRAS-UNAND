                ...
                <div class="bg-white p-8 rounded-2xl shadow-lg">
                    ...
                    <form method="POST" action="{{ route('password.change.update') }}" class="space-y-6">
                        ...
                        <div class="flex space-x-4">
                            ...
                            <button type="submit" 
                                class="flex-1 flex items-center justify-center px-4 py-2.5 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 focus:ring-4 focus:ring-green-300 transition-colors">
