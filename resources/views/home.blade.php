         ...
         <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="mr-auto place-self-center lg:col-span-7">
               ...
               <p class="max-w-2xl mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl">
                  Peminjaman Sarana & Prasarana Universitas Andalas dengan mudah dan efisien. Sistem modern untuk manajemen fasilitas kampus yang lebih baik.
               </p>
            <a href="{{ route('user.sarana') }}" class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-green-300">
                  Mulai Sekarang
         ...
         <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-16">
             ...
             <div class="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
                 ...
                 <div class="p-6 bg-white rounded-lg shadow-md">
                     ...
                     <p class="text-gray-500">Lihat jadwal dan ketersediaan sarana secara langsung melalui kalender interaktif.</p>
                 </div>
                 <!-- Feature 2 -->
                 <div class="p-6 bg-white rounded-lg shadow-md">
                     <div class="flex justify-center items-center mb-4 w-10 h-10 rounded-full bg-green-100 lg:h-12 lg:w-12">
                 ...
                 <div class="p-6 bg-white rounded-lg shadow-md">
                     ...
                     <p class="text-gray-500">Lacak status peminjaman Anda dan terima notifikasi pembaruan secara langsung.</p>
                 </div>
             </div>
         </div>
     </section>
               ...
               <div id="accordion-flush" data-accordion="collapse" data-active-classes="bg-white text-gray-900" data-inactive-classes="text-gray-500">
                  ...
                  <div id="accordion-flush-body-1" class="hidden" aria-labelledby="accordion-flush-heading-1">
                     <div class="py-5 border-b border-gray-200">
                        <p class="mb-2 text-gray-500">Pendaftaran SIMSAPRAS menggunakan akun Google anda. Ikuti proses verifikasi lalu anda bisa menggunakan SIMSAPRAS</p>
                     </div>
                  </div>
                  <!-- FAQ Item 2 -->
                  ...
                  <div id="accordion-flush-body-3" class="hidden" aria-labelledby="accordion-flush-heading-3">
                     <div class="py-5 border-b border-gray-200">
                        <p class="mb-2 text-gray-500">Persyaratan utama meliputi: status aktif sebagai mahasiswa/staff Unand, surat peminjaman yang resmi, dan rundown kegiatan.</p>
                     </div>
                  </div>
               </div>
            </div>
