            ...
            <div class="p-5">
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            @foreach ($peminjamanDiproses as $index => $item)
                                <tr
                                    class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                    <td class="px-6 py-4">
                                        {{ $loop->iteration + ($peminjamanDiproses->currentPage() - 1) * $peminjamanDiproses->perPage() }}
                                    </td>
                        ...
                        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                            <div>
                                <p class="text-sm text-gray-700 leading-5">
                                    Showing
                                    <span class="font-medium">{{ $peminjamanDiproses->firstItem() }}</span>
                                    to
                                    <span class="font-medium">{{ $peminjamanDiproses->lastItem() }}</span>
                                    of
                                    <span class="font-medium">{{ $peminjamanDiproses->total() }}</span>
                                    results
                                </p>
                            </div>
                            ...
                            <div>
                                <span class="relative z-0 inline-flex shadow-sm rounded-md">
                                    ...
                                    @else
                                        <a href="{{ $peminjamanDiproses->previousPageUrl() }}" rel="prev"
                                    ...
                                    {{-- Next Page Link --}}
                                    @if ($peminjamanDiproses->hasMorePages())
                                        <a href="{{ $peminjamanDiproses->nextPageUrl() }}" rel="next"
