               ...
               @if ($sarana->hasPages())
                  <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between">
                     <div class="flex justify-between flex-1 sm:hidden">
                        ...
                        @else
                           <a href="{{ $sarana->previousPageUrl() }}" class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:text-gray-500 focus:outline-none focus:ring ring-gray-300 focus:border-green-300 active:bg-gray-100 active:text-gray-700">
                              Previous
                           </a>
                        @endif

                        @if ($sarana->hasMorePages())
                           <a href="{{ $sarana->nextPageUrl() }}" class="relative inline-flex items-center px-4 py-2 ml-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg hover:text-gray-500 focus:outline-none focus:ring ring-gray-300 focus:border-green-300 active:bg-gray-100 active:text-gray-700">
                              Next
                           </a>
                        @else
                             ...
                             <div class="mb-4">
                              ...
                              <p class="mt-1 text-xs text-gray-500">Jika dicentang, sarana ini hanya bisa dipinjam Fakultas/Unit Internal Universitas Andalas</p>
                                 ...
                                 <div>
                                    ...
                                    <input type="file" name="gambar_tambahan[]" multiple class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50" accept=".jpg,.jpeg,.png,image/jpeg,image/png">
                             ...
                             <div class="mb-4">
                              ...
                              <p class="mt-1 text-xs text-gray-500">Jika dicentang, sarana ini hanya bisa dipinjam Fakultas/Unit Internal Universitas Andalas</p>
                                 ...
                                 <div>
                                    ...
                                    @endif
                                    <input type="file" name="gambar" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50" value="{{ $item->gambar }}" accept=".jpg,.jpeg,.png,image/jpeg,image/png">
                                 </div>
                                 <div>
                                    <label class="block mb-2 text-sm font-medium text-gray-900">Gambar Tambahan</label>
...
function activateSarana(activateUrl) {
    Swal.fire({
        title: 'Konfirmasi',
        text: "Apakah Anda yakin ingin mengaktifkan sarana ini?",
        icon: 'question',
        showCancelButton: true,
        confirmButtonColor: '#059669',
        cancelButtonColor: '#d33',
        ...
        if (result.isConfirmed) {
            ...
            .catch(error => {
                Swal.fire({
                    icon: 'error',
                    title: 'Gagal!',
                    text: error.message || 'Terjadi kesalahan saat mengaktifkan sarana',
                    timer: 2000,
                    showConfirmButton: false
                });
            });
