...
<div class="p-4 sm:p-6">
    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden">
        ...
        <div class="p-5">
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        @foreach ($peminjamanDitolak as $index => $item)
                        <tr
                            class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            <td class="px-6 py-4">
                                {{ $loop->iteration + ($peminjamanDitolak->currentPage() - 1) * $peminjamanDitolak->perPage() }}
                            </td>
                            ...
                            <td class="px-6 py-4">
                                <button data-modal-target="editModalDitolak{{ $item->id }}"
                                    data-modal-toggle="editModalDitolak{{ $item->id }}"
        ...
        <div class="px-6 py-4">
            @if ($peminjamanDitolak->hasPages())
            <nav role="navigation" aria-label="Pagination Navigation" class="flex items-center justify-between">
                <div class="flex justify-between flex-1 sm:hidden">
                    @if ($peminjamanDitolak->onFirstPage())
                    <span
                    ...
                    @else
                    <a href="{{ $peminjamanDitolak->previousPageUrl() }}"
                    ...
                    @if ($peminjamanDitolak->hasMorePages())
                    <a href="{{ $peminjamanDitolak->nextPageUrl() }}"
                ...
                <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                    <div>
                        <p class="text-sm text-gray-700 leading-5">
                            Showing
                            <span class="font-medium">{{ $peminjamanDitolak->firstItem() }}</span>
                            to
                            <span class="font-medium">{{ $peminjamanDitolak->lastItem() }}</span>
                            of
                            <span class="font-medium">{{ $peminjamanDitolak->total() }}</span>
                            results
                        </p>
                    </div>
                    ...
                    <div>
                        <span class="relative z-0 inline-flex shadow-sm rounded-md">
                            ...
                            @else
                            <a href="{{ $peminjamanDitolak->previousPageUrl() }}" rel="prev"
                            ...
                            @foreach ($peminjamanDitolak->getUrlRange(1, $peminjamanDitolak->lastPage()) as $page => $url)
                            @if ($page == $peminjamanDitolak->currentPage())
                            ...
                            {{-- Next Page Link --}}
                            @if ($peminjamanDitolak->hasMorePages())
                            <a href="{{ $peminjamanDitolak->nextPageUrl() }}" rel="next"
            ...
            <div class="relative flex flex-col max-h-[90vh] bg-white rounded-lg shadow">
                <div class="sticky top-0 z-10 flex items-start justify-between p-5 border-b rounded-t bg-gray-50">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="editModalDitolak{{ $item->id }}">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (openModalId) {
            const modal = document.getElementById(`editModalDitolak${openModalId}`);
            if (modal) {
    ...
    window.addEventListener('click', function(event) {
        const modals = document.querySelectorAll('[id^="editModalDitolak"]');
