                            ...
                            <td class="px-6 py-4">
                             ...
                             <td class="px-6 py-4">
                                <div class="flex space-x-2">
                                    ...
                                    @else
                                    <button onclick="activateRuangan('{{ route('ruangan.activate', ['idSarana' => $sarana->id, 'ruangan' => $item->id]) }}')"
...
function activateRuangan(activateUrl) {
    Swal.fire({
        title: 'Konfirmasi',
        text: "Apakah Anda yakin ingin mengaktifkan ruangan ini?",
        icon: 'question',
        showCancelButton: true,
        confirmButtonColor: '#059669',
        cancelButtonColor: '#d33',
        ...
        if (result.isConfirmed) {
            ...
            .catch(error => {
                Swal.fire({
                    icon: 'error',
                    title: 'Gagal!',
                    text: error.message || 'Terjadi kesalahan saat mengaktifkan ruangan',
                    timer: 2000,
                    showConfirmButton: false
                });
            });
